...
function Navbar({cartCount}) { // Accept cartCount as a prop
    ...
    const [isUserAuthenticated, setIsUserAuthenticated] = React.useState(false); // State to track user auth status
    ...
    const handleLogout = () => {
        ...
        setIsUserAuthenticated(false); // Mark user as logged out
        navigate('/');
    };
                            ...
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <div>
                                    ...
                                    <div className="dropdown-menu" aria-labelledby="dropdown07">
                                        {cookieExists && isUserAuthenticated ? (
                                            <>
